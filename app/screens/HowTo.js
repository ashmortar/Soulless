        ...
        >
          <View style={{flex: 1, opacity: 1}}>
            ...
            <View style={{justifyContent: 'center', alignItems: 'center', marginTop: 45, marginBottom: 10}}>
              ...
              <Text style={{justifyContent: 'center', alignItems: 'center', color: '#fff', fontFamily: 'Perfect DOS VGA 437', marginTop: 5, fontSize: 24 }}>Controls</Text>
